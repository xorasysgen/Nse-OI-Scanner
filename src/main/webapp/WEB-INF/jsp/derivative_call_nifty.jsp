...
<html>
  <head>
    <title>Intraday Top Call Nifty</title>
...
<jsp:include page="js_css_include.jsp"/>
    ...
    $(document).ready(function() {
        $('#example').DataTable( {
            "processing": true,
            "order": [[ 5, "desc" ]],
            "ajax": "https://jsr101.herokuapp.com/derivative/call/call_nifty",
            "columns": [
            	  { "data": "instrumentType" },
                  { "data": "symbol",
...
<legend>Intraday Top Call Nifty</legend>
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">Nifty Calls</h3>
    </div>
