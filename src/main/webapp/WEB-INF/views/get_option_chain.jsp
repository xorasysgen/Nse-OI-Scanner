...
<html>
  <head>
    <title>Stocks Option Chain Analysis</title>
...
<body>
	<div class="container ">
		<form:form class="form-horizontal" method="post"	action="${pageContext.request.contextPath}${actionUri}"	modelAttribute="stockName">
			<h3 class="form-signin-heading form-group col-sm-8">Stocks Option Chain Scrutiny</h3>
...
<legend>Stocks Option Chain (Equity Derivatives)<span class="pink"> </sub></span></legend>
