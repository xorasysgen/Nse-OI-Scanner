...
<html>
  <head>
    <title>Most Active Futures Values Wise</title>
...
<jsp:include page="js_css_include.jsp"/>
    ...
    $(document).ready(function() {
        $('#example').DataTable( {
            "processing": true,
            "order": [[ 3, "desc" ]],
            "ajax": "future_stocks_spike_value",
            "columns": [
                { "data": "instrumentType" },
                { "data": "expiryDate" },
                { "data": "symbol",
...
<legend>Intraday Most Active Futures Values Wise</legend>
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">Most Active Future - Values</h3>
    </div>
